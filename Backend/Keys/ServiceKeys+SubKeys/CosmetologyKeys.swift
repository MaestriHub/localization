...
public extension ServiceKeys.CosmetologyKeys {
    var classicCleaning: ClassicCleaningKeys { ClassicCleaningKeys() }
    var facialMassage:   FacialMassageKeys   { FacialMassageKeys() }
    var facialPeeling:   FacialPeelingKeys   { FacialPeelingKeys() }
